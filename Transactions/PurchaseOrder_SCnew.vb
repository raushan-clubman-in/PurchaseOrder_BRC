    ...
    Public Sub View_Report(suppcode As String, pono As String)
        ...
        Try
            ...
            If gdataset.Tables("VW_PO_POBILL").Rows.Count > 0 Then
                ...
                Text54 = "Tel: " & GPHONE & " 40090019 , Fax:" & gFax & ", Email:pur@kga.in" & ", Web:" & gWebsite
                Text20 = "TIN No.: " & gTinNo & ",Service Tax: " & gServiceTax.ToUpper() & " CST.10986984 ".ToUpper() & " GSTIN No. :" & gGSTINCode.ToUpper()
